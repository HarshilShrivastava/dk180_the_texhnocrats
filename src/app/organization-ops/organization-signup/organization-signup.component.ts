...
@Component({
  ...
  styleUrls: ['./organization-signup.component.less']
})
      ...
      this.quizService.register(form.value).subscribe((data: any) => {
        ...
        if (data.response === 201) {
          ...
          this.quizService.userLogin(this.uname, this.pw).subscribe((data: any) => {
            ...
            localStorage.setItem("Is_Candidate", JSON.stringify(false));
            localStorage.setItem("Is_Organization", JSON.stringify(true));
